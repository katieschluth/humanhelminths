...
#This is definitely not the most effective way to get all the data to print, but I can't figure out the code to just read the whole sheet. I feel like this should be simple. Thoughts?
